...
[DXLook](https://dxlook.com) has released a new D-RAP (D-Region Absorption Prediction) view that helps amateur radio operators understand and visualize HF absorption caused by solar X-ray flares in real time.
...
The D-RAP view is now live and available to all users at [https://dxlook.com](https://dxlook.com).
